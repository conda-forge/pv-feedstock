...
Development: https://codeberg.org/ivarch/pv
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pv-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pv-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=833&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pv-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
It is possible to list all of the versions of `pv` available on your platform:
...
```
pixi search pv --channel conda-forge
```
